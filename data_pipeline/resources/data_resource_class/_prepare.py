    ...
    cleaning_helpers: _CleaningHelpers,
        ...
        for idx, row in df.iterrows():
            try:
                ...
                df.at[idx, "name"] = cleaning_helpers.construct_name(row_dict)
                df.at[idx, "type"] = cleaning_helpers.construct_type(row_dict)
                df.at[idx, "geolocation"] = cleaning_helpers.construct_geolocation(row_dict)
                df.at[idx, "dno_group"] = self.dno_group
                df.at[idx, "external_identifier"] = cleaning_helpers.construct_external_identifier(row_dict)
                df.at[idx, "reference"] = self.reference
